...
abstention threshold. The comparison methods reported in the tables are
no-view Black--Litterman (BL), mean--variance optimization (MVO), and equal
weighting (EW).
...
evaluation metric for BL, MVO, EW, and PairBL.
